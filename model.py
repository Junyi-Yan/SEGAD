...
class Model(nn.Module):
    ...
    def forward(self, seq1, adj, sample_abnormal_idx, normal_idx, train_flag, args, sparse=False):
        ...
        if train_flag:
            ...
            neigh_adj_normal = adj[0, normal_idx, :]
            # emb[0, sample_abnormal_idx, :] =self.act(torch.mm(neigh_adj, emb[0, :, :]))
            # emb[0, sample_abnormal_idx, :] = self.fc4(emb[0, sample_abnormal_idx, :])

            emb_con_normal = torch.mm(neigh_adj_normal, emb[0, :, :])
            emb_con_normal = self.act(self.fc4(emb_con_normal))
        ...
        return emb, emb_combine, f_3, emb_con, emb_abnormal, emb_con_normal, emb_normal